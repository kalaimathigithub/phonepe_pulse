...
kalai = psycopg2.connect(host='localhost', port=5432,
                             user='postgres', password='root', database='Phonepe_Pulse')
cursor = kalai.cursor()
...
Aggre_trans = pd.DataFrame(table_1,columns = ("States", "Years", "Quarter", "Transaction_type", "Transaction_count", "Transaction_amount"))

#Aggregated_user
cursor.execute("select * from aggregated_user")
kalai.commit()
table_2 = cursor.fetchall()
Aggre_user = pd.DataFrame(table_2,columns = ("States", "Years", "Quarter", "Brands", "Transaction_count", "Percentage"))

#Map_transaction
cursor.execute("select * from map_transaction")
kalai.commit()
table_3 = cursor.fetchall()
Map_trans = pd.DataFrame(table_3,columns = ("States", "Years", "Quarter", "Districts", "Transaction_count", "Trans_amount"))
...
with tab1:
    ...
    with col2:
        st.video("E:/python/project_2/project_2_phonepe_pulse/phonepe.ipynb/WhatsApp Video 2023-11-24 at 7.55.13 PM.mp4")
